...
always @(negedge VGA_VS) begin
    ...
    case(p2_state)
        ...
        JUMP: begin
            //x coordinate: 
            if (p2_x < (GAME_W - SPRITE_W)) begin
					p2_x <= p2_x + JUMP_SPEED_X;
				end
